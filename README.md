...
2.Working with multiple independent variables
...
2.Implement Ridge & Lasso Regression
...
2.If you want, I can also:

3.Make it more beginner-friendly

4.Make it more professional for placement

5.Customize it exactly according to your notebook content
